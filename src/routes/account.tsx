...
function AccountPage() {
  ...
  const getStatusLabel = (status: string) => {
    switch (status) {
      ...
      case "shipping":   return t("account.status_shipping");
      case "delivered":  return t("account.status_delivered");
      case "reshipped":  return t("account.status_reshipped");
      case "on_hold":    return t("account.status_on_hold");
  ...
  const getStatusStyle = (status: string) => {
    switch (status) {
      ...
      case "reshipped":  return "bg-purple-100 text-purple-800";
      case "on_hold":    return "bg-rose-100 text-rose-800";
